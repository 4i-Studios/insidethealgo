                ...
                Expanded(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Enter numbers to search (e.g. 64,34,25,12,22)',
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          ...
          children: [
            ...
            _buildColorLegendItem(Colors.orange, 'Checking'),
            const SizedBox(width: 16),
            _buildColorLegendItem(Colors.grey, 'Searched'),
            const SizedBox(width: 16),
            _buildColorLegendItem(Colors.green, 'Found'),
            const SizedBox(width: 16),
            _buildColorLegendItem(Colors.red, 'Not Found'),
          ],
        ),
      ),
    );
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          ...
          children: [
            _buildStatusChip(
              'Position',
              '${logic.currentIndex >= 0 ? logic.currentIndex : '-'}',
              Colors.orange,
            ),
...
Widget _buildAnimatedBars(BuildContext context) {
  ...
  Widget _buildCodeDisplay(BuildContext context) {
    ...
    String iValue = logic.currentIndex >= 0 ? '${logic.currentIndex}' : '0';
    String targetStr = '${logic.targetValue}';
    String arrI =
        (logic.currentIndex >= 0 && logic.currentIndex < logic.numbers.length)
        ? '${logic.numbers[logic.currentIndex]}'
        : 'arr[i]';
    ...
    List<Map<String, dynamic>> codeLines = [
      ...
      {'line': 1, 'text': '  int n = ${n};', 'indent': 1},
      {'line': 2, 'text': '  for (int i = $iValue; i < n; i++) {', 'indent': 1},
      {'line': 3, 'text': '    if ($arrI == $targetStr) {', 'indent': 2},
      {'line': 4, 'text': '      return i; // Found at index i', 'indent': 3},
      {'line': 5, 'text': '    }', 'indent': 2},
      {'line': 6, 'text': '  }', 'indent': 1},
      {'line': 7, 'text': '  return -1; // Not found', 'indent': 1},
        ...
        child: IntrinsicWidth(
          child: Column(
            ...
            children: codeLines.map((codeLine) {
              if (codeLine['line'] == 9 && !logic.searchCompleted) {
