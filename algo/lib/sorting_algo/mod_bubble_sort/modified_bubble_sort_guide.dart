...
class ModifiedBubbleSortGuide {
  ...
  static Widget _buildTitle() {
    return Row(
      children: [
        Icon(Icons.upgrade, color: Colors.blue.shade700, size: 24),
  ...
  static Widget _buildOptimization() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'If no swaps occur during a complete pass, the array is already sorted and we can stop early. This improves best-case performance from O(n²) to O(n).',
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              _buildStepItem(1, 'Initialize a "swapped" flag to false before each pass'),
              _buildStepItem(2, 'Compare adjacent elements in the array'),
              _buildStepItem(3, 'If elements are in wrong order, swap them and set swapped = true'),
              _buildStepItem(4, 'Continue this process for the entire array'),
              _buildStepItem(5, 'After each pass, check if swapped is still false'),
              _buildStepItem(6, 'If no swaps occurred, array is sorted - break early!'),
            ],
          ),
        ),
      ],
          ...
          child: Column(
            children: [
              ListTile(
                ...
                subtitle: const Text('Array is already sorted (improved!)'),
                dense: true,
              ),
              ListTile(
